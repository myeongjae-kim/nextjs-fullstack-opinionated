import { ApiError } from '@/core/common/domain/ApiError.ts';
...
import { isDatabaseError } from '@/core/common/util/withDatabaseErrorHandling.ts';
...
export const globalErrorHandler: ErrorHandler = ((e) => {
  ...
  // DB error를 여기서 처리해야 쿼리가 노출되지 않는다.
